...
<body>
    ...
    <div class="login-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <a href="/html/email_verification.html" style="display: block; margin-top: 7px;">Esqueci minha senha</a>
            <a href="cadastro.php" style="display: block; margin-top: 7px;">Fazer cadastro!</a>
